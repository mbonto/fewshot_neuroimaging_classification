The code in this folder is adapted from the original code of [MAML++] (https://github.com/AntreasAntoniou/HowToTrainYourMAMLPytorch).
Below is the README file included in the original code.
