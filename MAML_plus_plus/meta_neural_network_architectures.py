...
class Conv1d(nn.Module):
    def __init__(self, num_output_classes, args, device, meta_classifier=True):
        ...
        Parameters:
            input_shape -- Input batch shape [batch_size, number channels, height].
...
class GNN(nn.Module):
    def __init__(self, num_output_classes, args, device, meta_classifier=True):
        ...
        connectivity_matrix_path = '/home/brain/Myriam/fMRI_transfer/few-shot/data/SC_avg56.mat'
        connectivity = sio.loadmat(connectivity_matrix_path)['SC_avg56']      
        self.graph = compute_laplacian(connectivity).cuda()  ##
